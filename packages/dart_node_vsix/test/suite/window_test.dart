...
void main() {
  ...
  suite('Window API', syncTest(() {
    suiteSetup(asyncTest(() async {
      await waitForExtensionActivation();
    }));

    test('showInformationMessage returns promise', syncTest(() {
      ...
      assertOk(promise != null, 'showInformationMessage should return promise');
    }));

    test('MessageOptions can be created', syncTest(() {
    ...
    test('InputBoxOptions can be created', syncTest(() {
    ...
    test('QuickPickOptions can be created', syncTest(() {
    ...
    test('ViewColumn constants are correct', syncTest(() {
