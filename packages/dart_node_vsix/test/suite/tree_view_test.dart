...
void main() {
  ...
  suite(
    ...
    syncTest(() {
      ...
      test(
        'Tree view has correct item count',
        syncTest(() {
      ...
      test(
        'TreeItem can be created with label',
        syncTest(() {
      ...
      test(
        'TreeItem collapsible state defaults to none',
        syncTest(() {
      ...
      test(
        'TreeItem can be created with collapsible state',
        syncTest(() {
      ...
      test(
        'TreeItem description can be set',
        syncTest(() {
      ...
      test(
        'TreeItemCollapsibleState has correct values',
        syncTest(() {
      ...
      test(
        'fireTreeChange triggers update',
        syncTest(() {
