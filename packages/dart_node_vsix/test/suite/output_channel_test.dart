...
void main() {
  ...
  suite('Output Channel API', syncTest(() {
    ...
    test('Output channel clear works', syncTest(() {
    ...
    test('Output channel show and hide work', syncTest(() {
