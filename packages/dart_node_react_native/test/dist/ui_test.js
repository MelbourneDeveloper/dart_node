...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    rnSwitch(onValueChange, props, value) {
      var p = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      p.$indexSet(0, "value", value);
      p.$indexSet(0, "onValueChange", A._functionToJS1(new A.rnSwitch_closure(onValueChange)));
      p.addAll$1(0, props);
      return A.rnElement("Switch", null, null, p);
    },
    textInput_closure: function textInput_closure(t0) {
      this.onChangeText = t0;
    },
    rnSwitch_closure: function rnSwitch_closure(t0) {
      this.onValueChange = t0;
    },
    _resolveReactNative() {
      var t1 = init.G,
    ...
    waitFor(callback) {
      ...
      return A._asJSObject(init.G.rnTestingLibrary.waitFor(callback));
    },
    ...
    getAllByText(text) {
      var _0_0, t1;
      A._asString(text);
      _0_0 = A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "getAllByText", text, null, type$.nullable_Object);
      $label0$0: {
        if (Array.isArray(_0_0)) {
          t1 = _0_0;
          break $label0$0;
        }
        t1 = A.throwExpression(A.StateError$('No elements found with text "' + text + '"'));
      }
      return t1;
    },
    queryByPlaceholder(text) {
      A._asString(text);
      return A._asJSObjectQ(A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "queryByPlaceholderText", text, null, type$.nullable_Object));
    },
    getByPlaceholder(text) {
      var _0_0, t1;
      A._asString(text);
      _0_0 = A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "getByPlaceholderText", text, null, type$.nullable_Object);
      $label0$0: {
        if (type$.JSObject._is(_0_0)) {
          t1 = _0_0;
          break $label0$0;
        }
        t1 = A.throwExpression(A.StateError$('Element with placeholder "' + text + '" not found'));
      }
      return t1;
    },
    press(element) {
    ...
    counterComponent() {
      return A.createElement(A.createFunctionalComponent(new A.counterComponent_closure()), null, null);
    },
    formComponent(onSubmit) {
      return A.createElement(A.createFunctionalComponent(new A.formComponent_closure(onSubmit)), null, null);
    },
    toggleComponent() {
      return A.createElement(A.createFunctionalComponent(new A.toggleComponent_closure()), null, null);
    },
    listComponent() {
      return A.createElement(A.createFunctionalComponent(new A.listComponent_closure()), null, null);
    },
    switchComponent() {
      return A.createElement(A.createFunctionalComponent(new A.switchComponent_closure()), null, null);
    },
    loadingComponent() {
      return A.createElement(A.createFunctionalComponent(new A.loadingComponent_closure()), null, null);
    },
    main() {
      var result,
        t1 = init.G,
        _this = {};
      _this.counterComponent = A._functionToJS0(A.ui_test__counterComponent$closure());
      _this.formComponent = A._functionToJS1(new A.main_closure());
      _this.toggleComponent = A._functionToJS0(A.ui_test__toggleComponent$closure());
      _this.listComponent = A._functionToJS0(A.ui_test__listComponent$closure());
      _this.switchComponent = A._functionToJS0(A.ui_test__switchComponent$closure());
      _this.loadingComponent = A._functionToJS0(A.ui_test__loadingComponent$closure());
      _this.render = A._functionToJS1(A.ui_test__render$closure());
      _this.fireEvent = A._asJSObject(t1.rnTestingLibrary.fireEvent);
      _this.getByTestId = A._functionToJS1(A.ui_test__getByTestId$closure());
      _this.getByPlaceholder = A._functionToJS1(A.ui_test__getByPlaceholder$closure());
      ...
      _this.getAllByText = A._functionToJS1(A.ui_test__getAllByText$closure());
      _this.press = A._functionToJS1(A.ui_test__press$closure());
      _this.queryByPlaceholder = A._functionToJS1(A.ui_test__queryByPlaceholder$closure());
      _this.queryByTestId = A._functionToJS1(A.ui_test__queryByTestId$closure());
      if (typeof A.ui_test__changeText$closure() == "function")
        A.throwExpression(A.ArgumentError$("Attempting to rewrap a JS function."));
      result = function(_call, f) {
        return function(arg1, arg2) {
          return _call(f, arg1, arg2, arguments.length);
        };
      }(A._callDartFunctionFast2, A.ui_test__changeText$closure());
      result[$.$get$DART_CLOSURE_PROPERTY_NAME()] = A.ui_test__changeText$closure();
      _this.changeText = result;
      _this.waitFor = A._functionToJS1(A.ui_test__waitFor$closure());
      t1.dartReactNativeTests = _this;
    },
    counterComponent_closure: function counterComponent_closure() {
    },
    counterComponent__closure: function counterComponent__closure(t0, t1) {
      this._box_0 = t0;
      this.count = t1;
    },
    counterComponent__closure0: function counterComponent__closure0(t0, t1) {
      this._box_0 = t0;
      this.count = t1;
    },
    counterComponent__closure1: function counterComponent__closure1(t0) {
      this._box_0 = t0;
    },
    formComponent_closure: function formComponent_closure(t0) {
      this.onSubmit = t0;
    },
    formComponent_closure_handleSubmit: function formComponent_closure_handleSubmit(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.email = t1;
      _.password = t2;
    ...
    formComponent__handleSubmit_closure: function formComponent__handleSubmit_closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.onSubmit = t1;
      _.email = t2;
    ...
    formComponent__closure: function formComponent__closure(t0) {
      this._box_0 = t0;
    },
    formComponent__closure0: function formComponent__closure0(t0) {
      this._box_0 = t0;
    },
    toggleComponent_closure: function toggleComponent_closure() {
    },
    toggleComponent__closure: function toggleComponent__closure(t0, t1) {
      this._box_0 = t0;
      this.isOn = t1;
    },
    listComponent_closure: function listComponent_closure() {
    },
    listComponent_closure_addItem: function listComponent_closure_addItem(t0, t1, t2) {
      this._box_0 = t0;
      this.inputValue = t1;
      this.items = t2;
    },
    listComponent__addItem_closure: function listComponent__addItem_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.items = t1;
      this.inputValue = t2;
    },
    listComponent_closure_removeItem: function listComponent_closure_removeItem(t0, t1) {
      this._box_0 = t0;
      this.items = t1;
    },
    listComponent__closure: function listComponent__closure(t0) {
      this._box_0 = t0;
    },
    listComponent__closure0: function listComponent__closure0(t0) {
      this.removeItem = t0;
    },
    listComponent___closure: function listComponent___closure(t0, t1) {
      this.removeItem = t0;
      this.entry = t1;
    },
    switchComponent_closure: function switchComponent_closure() {
    },
    switchComponent__closure: function switchComponent__closure(t0) {
      this._box_0 = t0;
    },
    loadingComponent_closure: function loadingComponent_closure() {
    },
    loadingComponent__closure: function loadingComponent__closure(t0, t1) {
      this._box_0 = t0;
      this.isLoading = t1;
    },
  ...
  A.rnSwitch_closure.prototype = {
    call$1(v) {
      return this.onValueChange.call$1(A._asBool(v));
    },
    $signature: 6
  };
  ...
  A.counterComponent_closure.prototype = {
    call$1(props) {
      var _0_0, t2, count, t3, t4, t5, t6, t7, _null = null, t1 = {};
      t1.setCount = null;
      _0_0 = A.useState(0);
      t1.setCount = _0_0._1;
      t2 = A._asDoubleQ(_0_0._0);
      count = t2 == null ? _null : A._asInt(t2);
      if (count == null)
        count = 0;
      t2 = type$.String;
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "counter-container"], t2, t3);
      t5 = A.text("Count: " + count, A.LinkedHashMap_LinkedHashMap$_literal(["testID", "count-display"], t2, t3));
      t6 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "increment-btn"], t2, t3);
      t6 = A.touchableOpacity(A.text("Increment", _null), new A.counterComponent__closure(t1, count), t6);
      t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "decrement-btn"], t2, t3);
      t7 = A.touchableOpacity(A.text("Decrement", _null), new A.counterComponent__closure0(t1, count), t7);
      t3 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "reset-btn"], t2, t3);
      return A.view(_null, A._setArrayType([t5, t6, t7, A.touchableOpacity(A.text("Reset", _null), new A.counterComponent__closure1(t1), t3)], type$.JSArray_JSObject), t4);
    },
    $signature: 1
  };
  A.counterComponent__closure.prototype = {
    call$0() {
      return this._box_0.setCount.call(null, this.count + 1);
    },
    $signature: 0
  };
  A.counterComponent__closure0.prototype = {
    call$0() {
      return this._box_0.setCount.call(null, this.count - 1);
    },
    $signature: 0
  };
  A.counterComponent__closure1.prototype = {
    call$0() {
      return this._box_0.setCount.call(null, 0);
    },
    $signature: 0
  };
  A.formComponent_closure.prototype = {
    call$1(props) {
      var _0_0, _1_0, _2_0, _3_0, t2, email, password, error, t3, t4, t5, t6, t7, _null = null, t1 = {};
      t1.setEmail = null;
      _0_0 = A.useState("");
      t1.setEmail = _0_0._1;
      t1.setPass = null;
      ...
      t1.setPass = _1_0._1;
      t1.setError = null;
      _2_0 = A.useState(_null);
      t1.setError = _2_0._1;
      t1.setSubmitted = null;
      _3_0 = A.useState(false);
      t1.setSubmitted = _3_0._1;
      t2 = A._asStringQ(_0_0._0);
      email = t2 == null ? _null : t2;
      if (email == null)
        email = "";
      t2 = A._asStringQ(_1_0._0);
      password = t2 == null ? _null : t2;
      if (password == null)
        password = "";
      error = A._asStringQ(_2_0._0);
      if (error == null)
        error = _null;
      t2 = A._asBoolQ(_3_0._0);
      if (t2 == null)
        t2 = _null;
      t3 = type$.String;
      t4 = type$.dynamic;
      t5 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "form-container"], t3, t4);
      t6 = A._setArrayType([], type$.JSArray_JSObject);
      if (error != null) {
        t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "error-message"], t3, t4);
        t6.push(A.view(A.text(error, _null), _null, t7));
      } else
        t6.push(A.view(_null, _null, _null));
      if (t2 === true) {
        t2 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "success-message"], t3, t4);
        t6.push(A.view(A.text("Form submitted!", _null), _null, t2));
      } else
        t6.push(A.view(_null, _null, _null));
      t6.push(A.textInput(new A.formComponent__closure(t1), "Enter email", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "email-input"], t3, t4), _null, email));
      t6.push(A.textInput(new A.formComponent__closure0(t1), "Enter password", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "password-input"], t3, t4), true, password));
      t2 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "submit-btn"], t3, t4);
      t6.push(A.touchableOpacity(A.text("Submit", _null), new A.formComponent_closure_handleSubmit(t1, email, password, this.onSubmit), t2));
      return A.view(_null, t6, t5);
    },
    $signature: 1
  };
  A.formComponent_closure_handleSubmit.prototype = {
    call$0() {
      var _this = this,
        t1 = _this.email,
        ...
        t3 = _this._box_0;
      if (t2)
        t3.setError.call(null, "All fields required");
      else
        new A.formComponent__handleSubmit_closure(t3, _this.onSubmit, t1, _this.password).call$0();
    },
    $signature: 0
  };
  A.formComponent__handleSubmit_closure.prototype = {
    call$0() {
      var _this = this,
        t1 = _this._box_0;
      t1.setError.call();
      t1.setSubmitted.call(null, true);
      t1 = _this.onSubmit;
      if (t1 != null)
  ...
  A.formComponent__closure.prototype = {
    call$1(val) {
      return this._box_0.setEmail.call(null, val);
    },
    $signature: 3
  };
  A.formComponent__closure0.prototype = {
    call$1(val) {
      return this._box_0.setPass.call(null, val);
    },
    $signature: 3
  };
  A.toggleComponent_closure.prototype = {
    call$1(props) {
      var _0_0, t2, isOn, t3, t4, t5, t1 = {};
      t1.setOn = null;
      _0_0 = A.useState(false);
      t1.setOn = _0_0._1;
      t2 = A._asBoolQ(_0_0._0);
      if (t2 == null)
        t2 = null;
      isOn = t2 === true;
      t2 = type$.String;
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "toggle-container"], t2, t3);
      t5 = isOn ? "ON" : "OFF";
      t5 = A.text(t5, A.LinkedHashMap_LinkedHashMap$_literal(["testID", "toggle-status"], t2, t3));
      t3 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "toggle-btn"], t2, t3);
      return A.view(null, A._setArrayType([t5, A.touchableOpacity(A.text("Toggle", null), new A.toggleComponent__closure(t1, isOn), t3)], type$.JSArray_JSObject), t4);
    },
    $signature: 1
  };
  A.toggleComponent__closure.prototype = {
    call$0() {
      return this._box_0.setOn.call(null, !this.isOn);
    },
    $signature: 0
  };
  A.listComponent_closure.prototype = {
    call$1(props) {
      var _0_0, _1_0, t2, items, inputValue, t3, t4, t5, t6, t7, _null = null, t1 = {};
      t1.setItems = null;
      _0_0 = A.useState(A._setArrayType([], type$.JSArray_Object));
      t1.setItems = _0_0._1;
      t1.setInput = null;
      _1_0 = A.useState("");
      t1.setInput = _1_0._1;
      t2 = type$.nullable_JSArray_nullable_Object._as(_0_0._0);
      if (t2 == null)
        items = _null;
      else
        items = t2;
      if (items == null)
        items = [];
      t2 = A._asStringQ(_1_0._0);
      inputValue = t2 == null ? _null : t2;
      if (inputValue == null)
        inputValue = "";
      t2 = type$.String;
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "list-container"], t2, t3);
      t5 = A.textInput(new A.listComponent__closure(t1), "Add item", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "add-item-input"], t2, t3), _null, inputValue);
      t6 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "add-item-btn"], t2, t3);
      t7 = type$.JSArray_JSObject;
      t6 = A.view(_null, A._setArrayType([t5, A.touchableOpacity(A.text("Add", _null), new A.listComponent_closure_addItem(t1, inputValue, items), t6)], t7), _null);
      t5 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "items-list"], t2, t3);
      return A.view(_null, A._setArrayType([t6, A.view(_null, B.JSArray_methods.get$isEmpty(items) ? A._setArrayType([A.text("No items", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "empty-message"], t2, t3))], t7) : B.JSArray_methods.asMap$0(items).get$entries().map$1$1(0, new A.listComponent__closure0(new A.listComponent_closure_removeItem(t1, items)), type$.JSObject).toList$0(0), t5), A.text("Total: " + items.length, A.LinkedHashMap_LinkedHashMap$_literal(["testID", "items-count"], t2, t3))], t7), t4);
    },
    $signature: 1
  };
  A.listComponent_closure_addItem.prototype = {
    call$0() {
      var t1 = this.inputValue,
        t2 = null;
      switch (B.JSString_methods.trim$0(t1).length !== 0) {
        case true:
          t1 = new A.listComponent__addItem_closure(this._box_0, this.items, t1).call$0();
          break;
        case false:
          t1 = t2;
          break;
  ...
  A.listComponent__addItem_closure.prototype = {
    call$0() {
      var t2,
        t1 = A.List_List$_of(this.items, type$.nullable_Object);
      t1.push(this.inputValue);
      t2 = this._box_0;
      t2.setItems.call(null, t1);
      t2.setInput.call(null, "");
    },
    $signature: 7
  };
  A.listComponent_closure_removeItem.prototype = {
    call$1(index) {
      var t1 = A.List_List$_of(this.items, type$.nullable_Object);
      B.JSArray_methods.removeAt$1(t1, index);
      this._box_0.setItems.call(null, t1);
    },
    $signature: 14
  };
  A.listComponent__closure.prototype = {
    call$1(val) {
      return this._box_0.setInput.call(null, val);
    },
    $signature: 3
  };
  A.listComponent__closure0.prototype = {
    call$1(entry) {
      var t1, t2, t3, t4, _2_0, t5;
      type$.MapEntry_of_int_and_nullable_Object._as(entry);
      t1 = entry.key;
      t2 = "" + t1;
      t3 = type$.String;
      t4 = type$.dynamic;
      t1 = A.LinkedHashMap_LinkedHashMap$_literal(["key", t1, "testID", "list-item-" + t2], t3, t4);
      _2_0 = entry.value;
      $label0$1: {
      ...
      t5 = A.text(t5, null);
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "remove-btn-" + t2], t3, t4);
      return A.view(null, A._setArrayType([t5, A.touchableOpacity(A.text("Remove", null), new A.listComponent___closure(this.removeItem, entry), t4)], type$.JSArray_JSObject), t1);
    },
    $signature: 15
  };
  A.listComponent___closure.prototype = {
    call$0() {
      return this.removeItem.call$1(this.entry.key);
    },
    $signature: 0
  };
  A.switchComponent_closure.prototype = {
    call$1(props) {
      var _0_0, t2, isOn, t3, t4, t5, t1 = {};
      t1.setOn = null;
      _0_0 = A.useState(false);
      ...
      t2 = type$.String;
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "switch-container"], t2, t3);
      t5 = isOn ? "Enabled" : "Disabled";
      return A.view(null, A._setArrayType([A.text(t5, A.LinkedHashMap_LinkedHashMap$_literal(["testID", "switch-status"], t2, t3)), A.rnSwitch(new A.switchComponent__closure(t1), A.LinkedHashMap_LinkedHashMap$_literal(["testID", "switch-control"], t2, t3), isOn)], type$.JSArray_JSObject), t4);
    },
    $signature: 1
  };
  A.switchComponent__closure.prototype = {
    call$1(val) {
      return this._box_0.setOn.call(null, val);
    },
    $signature: 6
  };
  A.loadingComponent_closure.prototype = {
    call$1(props) {
      var _0_0, t2, isLoading, t3, t4, t5, t6, p, _null = null, t1 = {};
      t1.setLoading = null;
      _0_0 = A.useState(true);
      t1.setLoading = _0_0._1;
      t2 = A._asBoolQ(_0_0._0);
      if (t2 == null)
        t2 = _null;
      isLoading = t2 !== false;
      t2 = type$.String;
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "loading-container"], t2, t3);
      t5 = A._setArrayType([], type$.JSArray_JSObject);
      if (isLoading) {
        t6 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "loading-indicator"], t2, t3);
        p = A.LinkedHashMap_LinkedHashMap$_empty(t2, t3);
        p.$indexSet(0, "color", "#6366f1");
        p.$indexSet(0, "size", "large");
        p.addAll$1(0, t6);
        t5.push(A.rnElement("ActivityIndicator", _null, _null, p));
      } else
        t5.push(A.text("Content loaded", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "loaded-content"], t2, t3)));
      t2 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "toggle-loading-btn"], t2, t3);
      t5.push(A.touchableOpacity(A.text(isLoading ? "Finish loading" : "Start loading", _null), new A.loadingComponent__closure(t1, isLoading), t2));
      return A.view(_null, t5, t4);
    },
    $signature: 1
  };
  A.loadingComponent__closure.prototype = {
    call$0() {
      return this._box_0.setLoading.call(null, !this.isLoading);
    },
    $signature: 0
  };
  A.main_closure.prototype = {
    call$1(onSubmit) {
      return onSubmit == null ? A.formComponent(null) : A.formComponent(new A.main__closure(onSubmit));
    },
    $signature: 16
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "ui_test__waitFor$closure", "waitFor", 18);
    _static_1(A, "ui_test__queryByTestId$closure", "queryByTestId", 4);
    _static_1(A, "ui_test__getByTestId$closure", "getByTestId", 5);
    _static_1(A, "ui_test__queryByText$closure", "queryByText", 4);
    _static_1(A, "ui_test__getByText$closure", "getByText", 5);
    _static_1(A, "ui_test__getAllByText$closure", "getAllByText", 19);
    _static_1(A, "ui_test__queryByPlaceholder$closure", "queryByPlaceholder", 4);
    _static_1(A, "ui_test__getByPlaceholder$closure", "getByPlaceholder", 5);
    _static_1(A, "ui_test__press$closure", "press", 20);
    _static_2(A, "ui_test__changeText$closure", "changeText", 21);
    _static_0(A, "ui_test__counterComponent$closure", "counterComponent", 2);
    _static_0(A, "ui_test__toggleComponent$closure", "toggleComponent", 2);
    _static_0(A, "ui_test__listComponent$closure", "listComponent", 2);
    _static_0(A, "ui_test__switchComponent$closure", "switchComponent", 2);
    _static_0(A, "ui_test__loadingComponent$closure", "loadingComponent", 2);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.MapBase, A._Record, A.Closure, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.Rti, A._FunctionParameters, A._Type, A._HashMapKeyIterator, A.ListBase, A._UnmodifiableMapMixin, A.MapEntry, A.Null, A.StringBuffer]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.MapBase_entries_closure, A.jsify__convert, A.textInput_closure, A.rnSwitch_closure, A.createFunctionalComponent_closure, A.counterComponent_closure, A.formComponent_closure, A.formComponent__closure, A.formComponent__closure0, A.toggleComponent_closure, A.listComponent_closure, A.listComponent_closure_removeItem, A.listComponent__closure, A.listComponent__closure0, A.switchComponent_closure, A.switchComponent__closure, A.loadingComponent_closure, A.main_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inheritMany(A.Closure2Args, [A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A.MapBase_mapToString_closure, A.main__closure]);
    ...
    _inheritMany(A.Closure0Args, [A.counterComponent__closure, A.counterComponent__closure0, A.counterComponent__closure1, A.formComponent_closure_handleSubmit, A.formComponent__handleSubmit_closure, A.toggleComponent__closure, A.listComponent_closure_addItem, A.listComponent__addItem_closure, A.listComponent___closure, A.loadingComponent__closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "JSObject(JSObject)", "JSObject()", "~(String)", "JSObject?(String)", "JSObject(String)", "~(bool)", "Null()", "@(@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "Object?(Object?)", "JSObject(Object)", "~(int)", "JSObject(MapEntry<int,Object?>)", "JSObject(Object?)", "~(String,String)", "JSObject(JavaScriptFunction)", "JSArray<Object?>(String)", "~(JSObject)", "~(JSObject,String)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      MapEntry_of_int_and_nullable_Object: findType("MapEntry<int,Object?>"),
      Null: findType("Null"),
