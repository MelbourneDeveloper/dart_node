...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    createElement(type, props, children) {
      ...
      if (children != null) {
        t1 = init.G.React;
        t2 = props == null ? {} : props;
        return A._asJSObject(t1.createElement(type, t2, children));
      } else if (props != null)
        return A._asJSObject(init.G.React.createElement(type, props));
      return A._asJSObject(init.G.React.createElement(type));
    },
    createProps(props) {
      var t1, t2, entry, converted, t3, _this0, _this = {};
      for (t1 = new A.LinkedHashMapEntriesIterable(props, A._instanceType(props)._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0), t2 = init.G; t1.moveNext$0();) {
        entry = t1.__js_helper$_current;
        converted = A._toJS(entry.value);
        t3 = t2.console;
        _this0 = entry.key;
        t3.log("createProps key:", _this0, "value:", converted);
        _this[_this0] = converted;
      }
      return _this;
    },
    _toJS(value) {
      ...
      $label0$0: {
        ...
        if (type$.void_Function._is(value)) {
          t1.fn = value;
          t1 = A._functionToJS1(new A._toJS_closure(t1));
          break $label0$0;
        }
        ...
        t1 = type$.JSObject._is(value) ? value : A.jsify(value);
        break $label0$0;
      }
      return t1;
    },
    _toJS_closure: function _toJS_closure(t0) {
      this._box_0 = t0;
    },
    main() {
      var t2, t3, props, t4, style, t5, flex, fontWeight, opacity, _null = null,
        t1 = init.G;
      t1.console.log("=== STYLE TEST START ===");
      t2 = type$.String;
      t3 = type$.dynamic;
      props = A._asJSObjectQ(A.div(A.LinkedHashMap_LinkedHashMap$_literal(["backgroundColor", "#ff0000", "padding", 20, "margin", "10px"], t2, t3)).props);
      t4 = props == null;
      A._assert(!t4, "div props should exist");
      style = A._asJSObjectQ(t4 ? _null : props.style);
      t5 = style == null;
      A._assert(!t5, "div style should exist");
      t4 = A._asStringQ(t5 ? _null : style.backgroundColor);
      A._assert((t4 == null ? _null : t4) === "#ff0000", "backgroundColor should be #ff0000");
      t4 = A._asStringQ(t5 ? _null : style.padding);
      A._assert((t4 == null ? _null : t4) === "20px", "padding should be 20px (numeric converted)");
      t4 = A._asStringQ(t5 ? _null : style.margin);
      A._assert((t4 == null ? _null : t4) === "10px", "margin should be 10px (string preserved)");
      t1.console.log("\u2713 testDivWithStyle passed");
      props = A._asJSObjectQ(A.button(A.LinkedHashMap_LinkedHashMap$_literal(["backgroundColor", "#6366f1", "borderRadius", 12, "color", "white"], t2, t3), "Click me").props);
      style = A._asJSObjectQ(props == null ? _null : props.style);
      t4 = style == null;
      A._assert(!t4, "button style should exist");
      t5 = A._asStringQ(t4 ? _null : style.backgroundColor);
      A._assert((t5 == null ? _null : t5) === "#6366f1", "button backgroundColor should be #6366f1");
      t5 = A._asStringQ(t4 ? _null : style.borderRadius);
      A._assert((t5 == null ? _null : t5) === "12px", "button borderRadius should be 12px");
      t1.console.log("\u2713 testButtonWithStyle passed");
      props = A._asJSObjectQ(A.input(A.LinkedHashMap_LinkedHashMap$_literal(["backgroundColor", "#12121a", "borderWidth", 1, "padding", 16], t2, t3), "text").props);
      style = A._asJSObjectQ(props == null ? _null : props.style);
      t4 = style == null;
      A._assert(!t4, "input style should exist");
      t5 = A._asStringQ(t4 ? _null : style.padding);
      A._assert((t5 == null ? _null : t5) === "16px", "input padding should be 16px");
      t1.console.log("\u2713 testInputWithStyle passed");
      props = A._asJSObjectQ(A.div(A.LinkedHashMap_LinkedHashMap$_literal(["width", 100, "height", 50, "borderRadius", 8, "fontSize", 16, "marginTop", 24, "paddingLeft", 12], t2, t3)).props);
      style = A._asJSObjectQ(props == null ? _null : props.style);
      t4 = style == null;
      t5 = A._asStringQ(t4 ? _null : style.width);
      A._assert((t5 == null ? _null : t5) === "100px", "width should have px suffix");
      t5 = A._asStringQ(t4 ? _null : style.height);
      A._assert((t5 == null ? _null : t5) === "50px", "height should have px suffix");
      t5 = A._asStringQ(t4 ? _null : style.borderRadius);
      A._assert((t5 == null ? _null : t5) === "8px", "borderRadius should have px suffix");
      t5 = A._asStringQ(t4 ? _null : style.fontSize);
      A._assert((t5 == null ? _null : t5) === "16px", "fontSize should have px suffix");
      t1.console.log("\u2713 testNumericPxConversion passed");
      props = A._asJSObjectQ(A.div(A.LinkedHashMap_LinkedHashMap$_literal(["flex", 1, "fontWeight", 600, "opacity", 0.5, "zIndex", 100, "lineHeight", 1.5, "order", 2], t2, t3)).props);
      style = A._asJSObjectQ(props == null ? _null : props.style);
      t2 = style == null;
      flex = t2 ? _null : style.flex;
      fontWeight = t2 ? _null : style.fontWeight;
      opacity = t2 ? _null : style.opacity;
      A._assert(flex != null && A._asInt(A._asDouble(flex)) === 1, 'flex should be number 1, not "1px"');
      A._assert(fontWeight != null && A._asInt(A._asDouble(fontWeight)) === 600, 'fontWeight should be number 600, not "600px"');
      A._assert(opacity != null && A._asDouble(opacity) === 0.5, 'opacity should be number 0.5, not "0.5px"');
      t1.console.log("\u2713 testNumericNoPxConversion passed");
      t1.console.log("=== ALL TESTS PASSED ===");
    },
    _assert(condition, message) {
      if (!condition)
        new A._assert_closure(message).call$0();
    },
    _assert_closure: function _assert_closure(t0) {
      this.message = t0;
    },
    ...
    _convertStyle(style) {
      var t1, entry, value, t2, _this0, jsValue, _this = {};
      for (t1 = new A.LinkedHashMapEntriesIterable(style, A._instanceType(style)._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0); t1.moveNext$0();) {
        entry = t1.__js_helper$_current;
        value = entry.value;
        t2 = typeof value == "number";
        if (t2 && !B.Set_qmugh.contains$1(0, entry.key)) {
          _this0 = A.S(value) + "px";
          jsValue = _this0;
          ...
          if (t2)
            ...
            t2 = A.jsify(value == null ? A._asObject(value) : value);
          jsValue = t2;
        }
        _this[entry.key] = jsValue;
      }
      return _this;
    },
    div(style) {
      var t1,
        p = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      p.$indexSet(0, "style", A._convertStyle(style));
      t1 = A.createElement("div", p.__js_helper$_length === 0 ? null : A.createProps(p), null);
      return t1;
    },
    button(style, text) {
  ...
  A._toJS_closure.prototype = {
    call$1(_) {
      return this._box_0.fn.call$0();
    },
    $signature: 5
  };
  A._assert_closure.prototype = {
    call$0() {
      var t1 = this.message;
      init.G.console.error("ASSERTION FAILED: " + t1);
      throw A.wrapException(A.StateError$("Test failed: " + t1));
    },
    $signature: 6
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A._KeysOrValuesOrElementsIterator, A.SetBase, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.Rti, A._FunctionParameters, A._Type, A._HashMapKeyIterator, A.ListBase, A.MapEntry, A.Null, A.StringBuffer]);
    ...
    _inherit(A.ConstantSet, A.SetBase);
    _inherit(A.ConstantStringSet, A.ConstantSet);
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.jsify__convert, A._toJS_closure]);
    ...
    _inherit(A._assert_closure, A.Closure0Args);
...
;
    B.Object_h42 = {flex: 0, fontWeight: 1, opacity: 2, zIndex: 3, lineHeight: 4, order: 5};
    B.Set_qmugh = new A.ConstantStringSet(B.Object_h42, 6, A.findType("ConstantStringSet<String>"));
...
//# sourceMappingURL=elements_test.js.map
