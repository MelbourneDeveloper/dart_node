...
void main() {
  test('useState initializes with the provided value', () {
  ...
  test('useState updates state when set is called', () {
    final counter = registerFunctionComponent((props) {
      final count = useState(0);
      return div(
        children: [
  ...
  test('useState updates state with functional updater', () {
    final counter = registerFunctionComponent((props) {
      final count = useState(0);
      return div(
        children: [
  ...
  test('useState handles multiple independent states', () {
  ...
  test('useState handles null values', () {
  ...
  test('useState handles complex object state via multiple state hooks', () {
  ...
  test('useState handles list state via string serialization', () {
