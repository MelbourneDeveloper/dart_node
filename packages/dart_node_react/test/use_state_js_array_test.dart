/// Tests for useStateJSArray hook.
@TestOn('js')
library;
...
void main() {
  test('useStateJSArray initializes with empty array', () {
  ...
  test('useStateJSArray adds items with set', () {
    final listComponent = registerFunctionComponent((props) {
      final items = useStateJSArray<JSObject>(<JSObject>[].toJS);
      return div(
        children: [
  ...
  test('useStateJSArray updates items with setWithUpdater', () {
    final listComponent = registerFunctionComponent((props) {
      final items = useStateJSArray<JSObject>(<JSObject>[].toJS);
      return div(
        children: [
  ...
  test('useStateJSArray renders list items from JSObject array', () {
    final listComponent = registerFunctionComponent((props) {
      final items = useStateJSArray<JSObject>(<JSObject>[].toJS);
      return div(
        children: [
  ...
  test('useStateJSArray filters items with setWithUpdater', () {
    final listComponent = registerFunctionComponent((props) {
      final items = useStateJSArray<JSObject>(<JSObject>[].toJS);
      return div(
        children: [
  ...
  test('useStateJSArray maps items with setWithUpdater', () {
    final listComponent = registerFunctionComponent((props) {
      final items = useStateJSArray<JSObject>(<JSObject>[].toJS);
