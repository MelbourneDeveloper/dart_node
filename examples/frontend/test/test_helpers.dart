/// Test helpers and mock utilities for frontend tests.
library;
...
JSTask createMockTask(Map<String, Object?> map) =>
    JSTask.fromJS(createJSObject(map));
...
Fetch createMockFetch(Map<String, Map<String, Object?>> responses) =>
    (url, {method = 'GET', token, body}) async {
      ...
      for (final entry in responses.entries) {
        // Skip method-prefixed keys for URL-only matching
...
/// Create a fetch function that throws to test catchError branches
