...
void main() {
  ...
  suite('Views', syncTest(() {
    ...
    test('Agents view is accessible', asyncTest(() async {
    ...
    test('Locks view is accessible', asyncTest(() async {
      ...
      try {
        await vscode.commands.executeCommand('tooManyCooksLocks.focus').toDart;
      } on Object {
    ...
    test('Messages view is accessible', asyncTest(() async {
  ...
  suite('UI Bug Fixes', syncTest(() {
    ...
    test(
      ...
      asyncTest(() async {
        ...
        final messagesMatch = RegExp(r'"messages"\s*:\s*\[').hasMatch(fetched);
