...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    view(child, children, props) {
      var p = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      if (props != null)
        p.addAll$1(0, props);
      return A.rnElement("View", child, children, p);
    },
    text($content, props) {
      var p = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      if (props != null)
        p.addAll$1(0, props);
      return A.rnElement("Text", $content, null, p);
    },
    textInput(onChangeText, placeholder, props, secureTextEntry, value) {
      var p = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      p.$indexSet(0, "value", value);
      p.$indexSet(0, "placeholder", placeholder);
      if (secureTextEntry != null)
        p.$indexSet(0, "secureTextEntry", secureTextEntry);
      p.$indexSet(0, "onChangeText", A._functionToJS1(new A.textInput_closure(onChangeText)));
      p.addAll$1(0, props);
      return A.rnElement("TextInput", null, null, p);
    },
    touchableOpacity(child, onPress, props) {
      var p = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.dynamic);
      if (onPress != null)
        p.$indexSet(0, "onPress", onPress);
      p.addAll$1(0, props);
      return A.rnElement("TouchableOpacity", child, null, p);
    },
    textInput_closure: function textInput_closure(t0) {
      this.onChangeText = t0;
    },
    _resolveReactNative() {
      var t1 = init.G,
        globalModule = t1.reactNative,
        t2 = type$.JSObject;
      if (t2._is(globalModule))
        return globalModule;
      t1 = type$.JavaScriptFunction._as(t1.require).call(null, "react-native");
      t1.toString;
      $label0$0: {
        if (t2._is(t1))
          break $label0$0;
        t1 = A.throwExpression(A.StateError$("react-native module not found"));
      }
      return t1;
    },
    rnElement(componentName, child, children, props) {
      var t1, t2, fullArgs, _this,
        component = A._resolveReactNative()[componentName],
        jsProps = A.createProps(props);
      $label0$0: {
        if (component != null) {
          if (children != null && children.length !== 0) {
            t1 = jsProps;
            t2 = init.G;
            fullArgs = type$.JSArray_nullable_Object._as(t2.Array.prototype.concat.call([component, t1], children));
            _this = A._asJSObject(t2.React.createElement.apply(null, fullArgs));
            t1 = _this;
          } else
            t1 = child != null ? A.createElement(component, jsProps, child) : A.createElement(component, jsProps, null);
          break $label0$0;
        }
        t1 = A.throwExpression(A.StateError$("Component " + componentName + " not found"));
      }
      return t1;
    },
    createFunctionalComponent(render) {
      return A._functionToJS1(new A.createFunctionalComponent_closure(render));
    },
    createFunctionalComponent_closure: function createFunctionalComponent_closure(t0) {
      this.render = t0;
    },
    ...
    render(element) {
      ...
      return A._asJSObject(init.G.rnTestingLibrary.render(element));
    },
    queryByTestId(testId) {
      A._asString(testId);
      return A._asJSObjectQ(A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "queryByTestId", testId, null, type$.nullable_Object));
    },
    getByTestId(testId) {
      var _0_0, t1;
      A._asString(testId);
      _0_0 = A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "getByTestId", testId, null, type$.nullable_Object);
      $label0$0: {
    ...
    queryByText(text) {
      A._asString(text);
      return A._asJSObjectQ(A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "queryByText", text, null, type$.nullable_Object));
    },
    getByText(text) {
      var _0_0, t1;
      A._asString(text);
      _0_0 = A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.screen), "getByText", text, null, type$.nullable_Object);
      $label0$0: {
        if (type$.JSObject._is(_0_0)) {
          t1 = _0_0;
          break $label0$0;
        }
        t1 = A.throwExpression(A.StateError$('Element with text "' + text + '" not found'));
      }
      return t1;
    },
    press(element) {
      A._asJSObject(element);
      A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.fireEvent), "press", element, null, type$.nullable_Object);
    },
    changeText(element, text) {
      A._asJSObject(element);
      A._asString(text);
      A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(init.G.rnTestingLibrary.fireEvent), "changeText", element, text, type$.nullable_Object);
    },
    loginScreenComponent(onRegisterClick, onSubmit) {
      return A.createElement(A.createFunctionalComponent(new A.loginScreenComponent_closure(onSubmit, onRegisterClick)), null, null);
    },
    registerScreenComponent(onLoginClick, onSubmit) {
      return A.createElement(A.createFunctionalComponent(new A.registerScreenComponent_closure(onSubmit, onLoginClick)), null, null);
    },
    taskListComponent(initialTasks) {
      return A.createElement(A.createFunctionalComponent(new A.taskListComponent_closure(initialTasks)), null, null);
    },
    headerComponent(onLogout, userName) {
      return A.createElement(A.createFunctionalComponent(new A.headerComponent_closure(userName, onLogout)), null, null);
    },
    main() {
      var _this = {};
      _this.loginScreenComponent = A._functionToJS2(new A.main_closure());
      _this.registerScreenComponent = A._functionToJS2(new A.main_closure0());
      _this.taskListComponent = A._functionToJS1(new A.main_closure1());
      ...
      _this.press = A._functionToJS1(A.ui_test__press$closure());
      _this.changeText = A._functionToJS2(A.ui_test__changeText$closure());
      init.G.mobileAppTests = _this;
    },
    loginScreenComponent_closure: function loginScreenComponent_closure(t0, t1) {
      this.onSubmit = t0;
      this.onRegisterClick = t1;
    },
    loginScreenComponent_closure_handleSubmit: function loginScreenComponent_closure_handleSubmit(t0, t1, t2, t3, t4) {
      var _ = this;
      _.email = t0;
      _.password = t1;
      _.setError = t2;
    ...
    loginScreenComponent__handleSubmit_closure: function loginScreenComponent__handleSubmit_closure(t0, t1, t2, t3, t4) {
      var _ = this;
      _.setLoading = t0;
      _.setError = t1;
      _.onSubmit = t2;
    ...
    registerScreenComponent_closure: function registerScreenComponent_closure(t0, t1) {
      this.onSubmit = t0;
      this.onLoginClick = t1;
    },
    registerScreenComponent_closure_handleSubmit: function registerScreenComponent_closure_handleSubmit(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.name = t0;
      _.email = t1;
      _.password = t2;
    ...
    registerScreenComponent__handleSubmit_closure: function registerScreenComponent__handleSubmit_closure(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.setLoading = t0;
      _.setError = t1;
      _.onSubmit = t2;
    ...
    taskListComponent_closure: function taskListComponent_closure(t0) {
      this.initialTasks = t0;
    },
    taskListComponent__closure: function taskListComponent__closure() {
    },
    taskListComponent_closure_addTask: function taskListComponent_closure_addTask(t0, t1, t2, t3) {
      var _ = this;
      _.newTask = t0;
      _.tasksState = t1;
      _.tasks = t2;
    ...
    taskListComponent_closure_toggleTask: function taskListComponent_closure_toggleTask(t0, t1) {
      this.tasks = t0;
      this.tasksState = t1;
    },
    taskListComponent__toggleTask_closure: function taskListComponent__toggleTask_closure(t0) {
      this.id = t0;
    },
    taskListComponent_closure_deleteTask: function taskListComponent_closure_deleteTask(t0, t1) {
      this.tasks = t0;
      this.tasksState = t1;
    },
    taskListComponent__deleteTask_closure: function taskListComponent__deleteTask_closure(t0) {
      this.id = t0;
    },
    taskListComponent__closure0: function taskListComponent__closure0() {
    },
    taskListComponent__closure1: function taskListComponent__closure1() {
    },
    taskListComponent__closure2: function taskListComponent__closure2(t0, t1) {
      this.toggleTask = t0;
      this.deleteTask = t1;
    },
    taskListComponent___closure: function taskListComponent___closure(t0, t1) {
      this.toggleTask = t0;
      this.id = t1;
    },
    taskListComponent___closure0: function taskListComponent___closure0(t0, t1) {
      this.deleteTask = t0;
      this.id = t1;
    },
    ...
    createProps(props) {
      var t1, entry, _this = {};
      for (t1 = new A.LinkedHashMapEntriesIterable(props, props.$ti._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0); t1.moveNext$0();) {
    ...
    _toJS(value) {
      ...
      $label0$0: {
        ...
        if (type$.void_Function._is(value)) {
          ...
          }(A._callDartFunctionFast0, value);
          result[$.$get$DART_CLOSURE_PROPERTY_NAME()] = value;
          t1 = result;
          break $label0$0;
        }
  ...
  A.textInput_closure.prototype = {
    call$1(t) {
      return this.onChangeText.call$1(A._asString(t));
    },
    $signature: 2
  };
  A.createFunctionalComponent_closure.prototype = {
    call$1(props) {
      return this.render.call$1(A._asJSObject(A._asObject(props)));
    },
    $signature: 13
  };
  ...
  A.loginScreenComponent_closure.prototype = {
    call$1(props) {
      var loading, t1, setEmail, setPassword, t2, t3, t4, t5, t6, t7, _null = null,
      ...
      t2 = new A.loginScreenComponent_closure_handleSubmit(email, password, A.wrapSetState(errorState._1, type$.nullable_String), A.wrapSetState(loadingState._1, type$.bool), this.onSubmit);
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "login-form"], t1, t3);
      t5 = type$.JSArray_JSObject;
      t6 = A._setArrayType([A.text("Sign In", _null)], t5);
      if (error != null) {
        t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "error-message"], t1, t3);
        t6.push(A.view(A.text(error, _null), _null, t7));
      } else
        t6.push(A.view(_null, _null, _null));
      t6.push(A.textInput(setEmail, "Email", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "email-input"], t1, t3), _null, email));
      t6.push(A.textInput(setPassword, "Password", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "password-input"], t1, t3), true, password));
      if (loading)
        t2 = _null;
      t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "submit-btn"], t1, t3);
      t6.push(A.touchableOpacity(A.text(loading ? "Signing in..." : "Sign In", _null), t2, t7));
      t2 = A.text("Don't have an account? ", _null);
      t3 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "register-link"], t1, t3);
      t6.push(A.view(_null, A._setArrayType([t2, A.touchableOpacity(A.text("Register", _null), this.onRegisterClick, t3)], t5), _null));
      return A.view(_null, t6, t4);
    },
    $signature: 1
  };
  A.loginScreenComponent_closure_handleSubmit.prototype = {
    call$0() {
      var _this = this,
        t1 = _this.email,
      ...
      if (t2)
        ...
        new A.loginScreenComponent__handleSubmit_closure(_this.setLoading, t3, _this.onSubmit, t1, _this.password).call$0();
    },
    $signature: 0
  };
  A.loginScreenComponent__handleSubmit_closure.prototype = {
    call$0() {
      var t1, _this = this;
  ...
  A.registerScreenComponent_closure.prototype = {
    call$1(props) {
      var loading, t1, setName, setEmail, setPassword, t2, t3, t4, t5, t6, t7, _null = null,
      ...
      setEmail = A.wrapSetState(emailState._1, t1);
      setPassword = A.wrapSetState(passState._1, t1);
      t2 = new A.registerScreenComponent_closure_handleSubmit($name, email, password, A.wrapSetState(errorState._1, type$.nullable_String), A.wrapSetState(loadingState._1, type$.bool), this.onSubmit);
      t3 = type$.dynamic;
      t4 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "register-form"], t1, t3);
      t5 = type$.JSArray_JSObject;
      t6 = A._setArrayType([A.text(_s14_, _null)], t5);
      if (error != null) {
        t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "error-message"], t1, t3);
        t6.push(A.view(A.text(error, _null), _null, t7));
      } else
        t6.push(A.view(_null, _null, _null));
      t6.push(A.textInput(setName, "Name", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "name-input"], t1, t3), _null, $name));
      t6.push(A.textInput(setEmail, "Email", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "email-input"], t1, t3), _null, email));
      t6.push(A.textInput(setPassword, "Password", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "password-input"], t1, t3), true, password));
      if (loading)
        t2 = _null;
      t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "submit-btn"], t1, t3);
      t6.push(A.touchableOpacity(A.text(loading ? "Creating..." : _s14_, _null), t2, t7));
      t2 = A.text("Already have an account? ", _null);
      t3 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "login-link"], t1, t3);
      t6.push(A.view(_null, A._setArrayType([t2, A.touchableOpacity(A.text("Sign In", _null), this.onLoginClick, t3)], t5), _null));
      return A.view(_null, t6, t4);
    },
    $signature: 1
  };
  A.registerScreenComponent_closure_handleSubmit.prototype = {
    call$0() {
      var _this = this,
        t1 = _this.name,
      ...
      if (t2)
        ...
        new A.registerScreenComponent__handleSubmit_closure(_this.setLoading, t3, _this.onSubmit, t1, _this.email, _this.password).call$0();
    },
    $signature: 0
  };
  A.registerScreenComponent__handleSubmit_closure.prototype = {
    call$0() {
      var t1, _this = this;
      _this.setLoading.call$1(true);
      _this.setError.call$1(null);
  ...
  A.taskListComponent_closure.prototype = {
    call$1(props) {
      var tasksState, newTaskState, tasks, newTask, setNewTask, t2, t3, taskList, completed, t4, t5, t6, t7, t8, t9, _null = null,
        t1 = this.initialTasks;
      if (t1 == null)
        t1 = A._setArrayType([], type$.JSArray_Map_String_dynamic);
      t1 = J.map$1$1$ax(t1, new A.taskListComponent__closure(), type$.Object);
      ...
      t2 = type$.JSObject;
      t3 = B.JSArray_methods.map$1$1(tasks, new A.taskListComponent__closure0(), t2);
      taskList = A.List_List$_of(t3, t3.$ti._eval$1("ListIterable.E"));
      t3 = A._arrayInstanceType(taskList);
      completed = new A.WhereIterable(taskList, t3._eval$1("bool(1)")._as(new A.taskListComponent__closure1()), t3._eval$1("WhereIterable<1>")).get$length(0);
      t4 = type$.dynamic;
      t5 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "task-manager"], t1, t4);
      t6 = type$.JSArray_JSObject;
      t7 = A.view(_null, A._setArrayType([A.text("Your Tasks", _null), A.text("" + completed + "/" + taskList.length + " completed", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "task-stats"], t1, t4))], t6), _null);
      t8 = A.textInput(setNewTask, "What needs to be done?", A.LinkedHashMap_LinkedHashMap$_literal(["testID", "new-task-input"], t1, t4), _null, newTask);
      t9 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "add-task-btn"], t1, t4);
      t9 = A.view(_null, A._setArrayType([t8, A.touchableOpacity(A.text("+ Add Task", _null), new A.taskListComponent_closure_addTask(newTask, tasksState, tasks, setNewTask), t9)], t6), _null);
      t8 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "task-list"], t1, t4);
      if (taskList.length === 0) {
        t1 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "empty-state"], t1, t4);
        t1 = A._setArrayType([A.view(A.text("No tasks yet", _null), _null, t1)], t6);
      } else
        t1 = new A.ListMapView(taskList, t3._eval$1("ListMapView<1>")).get$entries().map$1$1(0, new A.taskListComponent__closure2(new A.taskListComponent_closure_toggleTask(tasks, tasksState), new A.taskListComponent_closure_deleteTask(tasks, tasksState)), t2).toList$0(0);
      return A.view(_null, A._setArrayType([t7, t9, A.view(_null, t1, t8)], t6), t5);
    },
    $signature: 1
  };
  A.taskListComponent__closure.prototype = {
    call$1(t) {
      var _this;
  ...
  A.taskListComponent_closure_addTask.prototype = {
    call$0() {
  ...
  A.taskListComponent_closure_toggleTask.prototype = {
    call$1(id) {
      var t1 = J.map$1$1$ax(this.tasks, new A.taskListComponent__toggleTask_closure(id), type$.JSObject),
        updated = A.List_List$_of(t1, t1.$ti._eval$1("ListIterable.E"));
      this.tasksState._1.call(null, updated);
    },
    $signature: 2
  };
  A.taskListComponent__toggleTask_closure.prototype = {
    call$1(t) {
  ...
  A.taskListComponent_closure_deleteTask.prototype = {
    call$1(id) {
      var t1 = J.where$1$ax(this.tasks, new A.taskListComponent__deleteTask_closure(id)),
        filtered = A.List_List$_of(t1, t1.$ti._eval$1("Iterable.E"));
      this.tasksState._1.call(null, filtered);
    },
    $signature: 2
  };
  A.taskListComponent__deleteTask_closure.prototype = {
    call$1(t) {
      var t1, taskId;
      $label1$2: {
        if (type$.JSObject._is(t)) {
  ...
  A.taskListComponent__closure0.prototype = {
    call$1(t) {
      var t1;
      $label2$3: {
        if (type$.JSObject._is(t)) {
  ...
  A.taskListComponent__closure1.prototype = {
    call$1(t) {
      return A.boolFromState(A._asJSObject(t).completed);
    },
    $signature: 16
  };
  A.taskListComponent__closure2.prototype = {
    call$1(entry) {
      var task, _3_0, t1, _4_0, t2, isCompleted, t3, t4, t5, t6, t7, t8, _null = null;
      ...
      t4 = type$.String;
      t5 = type$.dynamic;
      t6 = A.LinkedHashMap_LinkedHashMap$_literal(["key", t1, "testID", "task-item-" + t3], t4, t5);
      t7 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "toggle-task-" + t3], t4, t5);
      t8 = isCompleted ? A.text("\u2713", _null) : A.text("", _null);
      t7 = A.touchableOpacity(t8, new A.taskListComponent___closure(this.toggleTask, t1), t7);
      t2 = A.text(t2, A.LinkedHashMap_LinkedHashMap$_literal(["testID", "task-title-" + t3], t4, t5));
      t5 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "delete-task-" + t3], t4, t5);
      return A.view(_null, A._setArrayType([t7, t2, A.touchableOpacity(A.text("\xd7", _null), new A.taskListComponent___closure0(this.deleteTask, t1), t5)], type$.JSArray_JSObject), t6);
    },
    $signature: 17
  };
  A.taskListComponent___closure.prototype = {
    call$0() {
      return this.toggleTask.call$1(this.id);
    },
    $signature: 0
  };
  A.taskListComponent___closure0.prototype = {
    call$0() {
  ...
  A.headerComponent_closure.prototype = {
    call$1(props) {
      var _null = null,
        t1 = type$.String,
        t2 = type$.dynamic,
        t3 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "app-header"], t1, t2),
        t4 = type$.JSArray_JSObject,
        t5 = A._setArrayType([A.text("TaskFlow", _null)], t4),
        t6 = this.userName;
      if (t6 != null) {
        t6 = A.text("Welcome, " + t6, A.LinkedHashMap_LinkedHashMap$_literal(["testID", "user-name"], t1, t2));
        t2 = A.LinkedHashMap_LinkedHashMap$_literal(["testID", "logout-btn"], t1, t2);
        t5.push(A.view(_null, A._setArrayType([t6, A.touchableOpacity(A.text("Logout", _null), this.onLogout, t2)], t4), _null));
      } else
        t5.push(A.view(_null, _null, _null));
      return A.view(_null, t5, t3);
    },
    $signature: 1
  };
  A.main_closure.prototype = {
    call$2(onSubmit, onRegisterClick) {
      var t1;
      if (onSubmit == null)
        t1 = A.loginScreenComponent(type$.JavaScriptFunction._is(onRegisterClick) ? new A.main__closure4(onRegisterClick) : null, null);
      else {
        t1 = type$.JavaScriptFunction._is(onRegisterClick) ? new A.main__closure5(onRegisterClick) : null;
        t1 = A.loginScreenComponent(t1, new A.main__closure6(onSubmit));
      }
      return t1;
    },
    $signature: 4
  ...
  A.main_closure0.prototype = {
    call$2(onSubmit, onLoginClick) {
      var t1;
      if (onSubmit == null)
        t1 = A.registerScreenComponent(type$.JavaScriptFunction._is(onLoginClick) ? new A.main__closure1(onLoginClick) : null, null);
      else {
        t1 = type$.JavaScriptFunction._is(onLoginClick) ? new A.main__closure2(onLoginClick) : null;
        t1 = A.registerScreenComponent(t1, new A.main__closure3(onSubmit));
      }
      return t1;
    },
    $signature: 4
  ...
  A.main_closure1.prototype = {
    call$1(initialTasks) {
      ...
      if (initialTasks == null)
        ...
        t1 = A.List_List$_of(t1, t1.$ti._eval$1("ListIterable.E"));
        t1 = A.taskListComponent(new A.CastList(t1, A._arrayInstanceType(t1)._eval$1("CastList<1,Map<String,@>>")));
      }
      return t1;
    },
    $signature: 3
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "ui_test__render$closure", "render", 1);
    _static_1(A, "ui_test__queryByTestId$closure", "queryByTestId", 6);
    _static_1(A, "ui_test__getByTestId$closure", "getByTestId", 7);
    _static_1(A, "ui_test__queryByText$closure", "queryByText", 6);
    _static_1(A, "ui_test__getByText$closure", "getByText", 7);
    _static_1(A, "ui_test__press$closure", "press", 21);
    _static_2(A, "ui_test__changeText$closure", "changeText", 22);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.MapBase_entries_closure, A.jsify__convert, A.textInput_closure, A.createFunctionalComponent_closure, A.wrapSetState_closure, A.loginScreenComponent_closure, A.registerScreenComponent_closure, A.taskListComponent_closure, A.taskListComponent__closure, A.taskListComponent_closure_toggleTask, A.taskListComponent__toggleTask_closure, A.taskListComponent_closure_deleteTask, A.taskListComponent__deleteTask_closure, A.taskListComponent__closure0, A.taskListComponent__closure1, A.taskListComponent__closure2, A.headerComponent_closure, A.main__closure3, A.main_closure1, A.main__closure0]);
    ...
    _inheritMany(A.Closure0Args, [A.loginScreenComponent_closure_handleSubmit, A.loginScreenComponent__handleSubmit_closure, A.registerScreenComponent_closure_handleSubmit, A.registerScreenComponent__handleSubmit_closure, A.taskListComponent_closure_addTask, A.taskListComponent___closure, A.taskListComponent___closure0, A.main__closure4, A.main__closure5, A.main__closure1, A.main__closure2, A.main__closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "JSObject(JSObject)", "~(String)", "JSObject(Object?)", "JSObject(Object?,Object?)", "Null()", "JSObject?(String)", "JSObject(String)", "@(@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "Object?(Object?)", "JSObject(Object)", "Object(Map<String,@>)", "bool(Object?)", "bool(JSObject)", "JSObject(MapEntry<int,JSObject>)", "~(String,String)", "~(String,String,String)", "Map<String,Object>(Object?)", "~(JSObject)", "~(JSObject,String)"],
