    ...
    syncTest(() {
      ...
      test(
        ...
        asyncTest(() async {
          ...
          _log('[LOCK STATE] desc="$desc", agentName="$agentName"');
          // Use startsWith for robust matching (desc: "agentName - Xs")
          assertOk(
            desc.startsWith(agentName),
            'Lock description should start with agent name, got: $desc',
          );
    ...
    syncTest(() {
      ...
      test(
        ...
        asyncTest(() async {
          ...
          final deleteAgentKey = extractKeyFromResult(regResult);
    ...
    syncTest(() {
      ...
      suiteSetup(
        asyncTest(() async {
          ...
          // Disconnect and clean database for fresh state
          await safeDisconnect();
          cleanDatabase();
      ...
      test(
        ...
        asyncTest(() async {
          ...
          // Verify message exists (may or may not be unread depending on
          // timing)
