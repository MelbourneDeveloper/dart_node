...
extension type TestAPI(JSObject _) implements JSObject {
  ...
  /// Call a database operation by name with the given arguments.
  /// Returns JSAny? to avoid dart2js cross-module type check issues.
  /// Use the `callToolString` helper to get the result as a Dart String.
  external JSPromise<JSAny?> callTool(String name, JSObject args);
